...
#     def test_profile_edit_link_for_own_profile(self):
#         self.client.login(username='user1', password='password1')
#         response = self.client.get(reverse('blog:profile', kwargs={'username': 'user1'}))
#         self.assertContains(response, 'Редактировать профиль')
#         self.assertContains(response, 'Изменить пароль')

#     def test_no_profile_edit_link_for_others_profile(self):
#         self.client.login(username='user1', password='password1')
#         response = self.client.get(reverse('blog:profile', kwargs={'username': 'user2'}))
#         self.assertNotContains(response, 'Редактировать профиль')
#         self.assertNotContains(response, 'Изменить пароль')